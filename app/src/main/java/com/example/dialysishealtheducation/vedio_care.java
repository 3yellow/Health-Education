...
public class vedio_care extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener{

    public static final String API_key = "AIzaSyD07V93XTujLIEDZMoJ_aoFdrlktHHL0to";
    public static final String Video_id = "rO9xWxKgDpM";//https://youtu.be/rO9xWxKgDpM 穿刺後的傷口照護
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vedio_care);
    ...
    public void onnext(View v) {
        if(flag==0){        //回到影片頁
            Intent intent = new Intent(vedio_care.this, choice_vedio.class);
            ...
            Intent intent = new Intent(vedio_care.this, backtest.class);
