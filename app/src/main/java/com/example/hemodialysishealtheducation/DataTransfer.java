...
public class DataTransfer extends AppCompatActivity {
    ...
    public void import_all(View v) throws IOException, ParseException {
        try {
            //importNurse("csvname/Nurse.csv");
            importPatient("csvname/Patient.csv");
            importQuestion("csvname/Question.csv");
            importStudy("csvname/Study.csv");
            importTopic("csvname/Topic.csv");
            importAnswer("csvname/Answer.csv");
            importExam("csvname/Exam.csv");
    ...
    private void exportNurse(String path) {
        ...
        try {
            ...
            File file=  new File(path,"Nurse.csv");
    ...
    private void exportPatient(String path) {
        StringBuilder data = new StringBuilder();
        try {
            File file=  new File(path,"Patient.csv");
    ...
    private void exportQuestion(String path) {
        StringBuilder data = new StringBuilder();
        try {
            File file=  new File(path,"Question.csv");
    ...
    private void exportStudy(String path) {
        StringBuilder data = new StringBuilder();
        try {
            File file=  new File(path,"Study.csv");
    ...
    private void exportTopic(String path) {
        StringBuilder data = new StringBuilder();
        try {
            File file=  new File(path,"Topic.csv");
    ...
    private void exportAnswer(String path) {
        StringBuilder data = new StringBuilder();
        try {
            File file=  new File(path,"Answer.csv");
    ...
    private void exportExam(String path) {
        StringBuilder data = new StringBuilder();
        try {
            File file=  new File(path,"Exam.csv");
    ...
    private void importNurse(String path) throws IOException, ParseException {
        ...
        csvReader.close();
        DBS.close();
        Toast.makeText(this, "Nurse Import success", Toast.LENGTH_LONG).show();
    }
    ...
    private void importPatient(String path) throws IOException, ParseException {
        ...
        csvReader.close();
        DBS.close();
        Toast.makeText(this, "Patient Import success", Toast.LENGTH_LONG).show();
    }
    ...
    private void importQuestion(String path) throws IOException, ParseException {
        ...
        csvReader.close();
        DBS.close();
        Toast.makeText(this, "Question Import success", Toast.LENGTH_LONG).show();
    }
    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    private void importStudy(String path) throws IOException, ParseException {
        ...
        csvReader.close();
        DBS.close();
        Toast.makeText(this, "Study Import success", Toast.LENGTH_LONG).show();
    }
    @RequiresApi(api = Build.VERSION_CODES.KITKAT)
    private void importTopic(String path) throws IOException, ParseException {
        ...
        csvReader.close();
        DBS.close();
        Toast.makeText(this, "Topic Import success", Toast.LENGTH_LONG).show();
    }
    ...
    private void importAnswer(String path) throws IOException, ParseException {
        ...
        csvReader.close();
        DBS.close();
        Toast.makeText(this, "Answer Import success", Toast.LENGTH_LONG).show();
    }
    ...
    private void importExam(String path) throws IOException, ParseException {
        ...
        csvReader.close();
        DBS.close();
        Toast.makeText(this, "Exam Import success", Toast.LENGTH_LONG).show();
    }
